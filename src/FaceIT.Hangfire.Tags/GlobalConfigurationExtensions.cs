...
namespace Hangfire.Tags
{
   ...
   public static class GlobalConfigurationExtensions
   {
      ...
      // RS Customize
      public static IGlobalConfiguration UseJobStorageFactory([NotNull] this IGlobalConfiguration configuration, Func<JobStorage> jobStorageFactory)
      {
         if (configuration == null) throw new ArgumentNullException(nameof(configuration));
         if (jobStorageFactory == null) throw new ArgumentNullException(nameof(jobStorageFactory));

         return configuration.Use(jobStorageFactory, x => HangfireExtensions.JobStorageFactory = x);
      }
   }
}